    ...
    runtime.block_on(async {
        ...
        let builder = tauri::Builder::default()
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                legacy::git::tauri_git_run_lfs_pull::git_run_lfs_pull,
                ...
                legacy::projects::tauri_project_health_check::project_health_check,
                legacy::projects::tauri_fix_repo_ownership::fix_repo_ownership,
