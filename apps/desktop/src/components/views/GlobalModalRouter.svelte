<script lang="ts">
	...
	import { getCloseInterceptor, clearCloseInterceptor } from "$lib/settings/settingsModal.svelte";
	...
	function handleModalClose() {
		...
		const interceptor = getCloseInterceptor();
		if (interceptor) {
			const allowClose = interceptor();
