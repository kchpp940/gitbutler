...
export enum OnboardingEvent {
	...
	ProjectAlreadyOpenInAnotherWindow = "project_already_open_in_another_window",
	ProjectDatabaseCorrupted = "project_database_corrupted",
	ProjectFilterWarning = "project_filter_warning",
	ProjectPermissionDenied = "project_permission_denied",
	ProjectInvalidGitRepository = "project_invalid_git_repository",
